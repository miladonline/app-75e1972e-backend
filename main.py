...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Display a friendly hello world message with optional custom name",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
...
async def _call_tool_request(
    ...
    if tool_name == "say_hello":
        ...
        data = {
            ...
            "greeting": "Welcome to the Hello World MCP App",
            "timestamp": "2024",
            "name": name,
        }
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"Hello, {name}! See the interactive greeting below.",
                )
            ],
            structuredContent={
